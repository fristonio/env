			...
			buffers = {
				...
				format = function(item, picker)
					...
					if item.buf and vim.bo[item.buf].modified then
						table.insert(ret, { "  ", "SnacksPickerModified" })
					end
					return ret
				end,
			},
...
vim.keymap.set({ "n", "v" }, "<leader>fe", snacks.picker.explorer, { desc = "Open file explorer" })

vim.keymap.set({ "n", "v" }, "<leader>ff", snacks.picker.files, { desc = "Find Files" })
...
vim.keymap.set({ "n", "v" }, "<leader>fo", snacks.picker.smart, { desc = "Smart finder" })

vim.keymap.set({ "n", "v" }, "<leader>fb", function()
	snacks.picker.buffers({ sort_mru = true })
end, { desc = "Find Buffers" })

vim.keymap.set({ "n", "v" }, "<leader>fr", snacks.picker.resume, { desc = "Find Resume" })
...
vim.keymap.set({ "n", "v" }, "<leader>/", snacks.picker.lines, { desc = "Fuzzily search in current buffer" })
...
vim.keymap.set({ "n", "v" }, "<leader>fg", snacks.picker.grep_buffers, { desc = "Live Grep in Open Files" })

vim.keymap.set(
	{ "n", "v" },
	"<leader>fd",
	snacks.picker.diagnostics_buffer,
	{ desc = "Find Diagnostic in current file" }
)
vim.keymap.set({ "n", "v" }, "<leader>fD", snacks.picker.diagnostics, { desc = "Find Diagnostics" })

vim.keymap.set({ "n", "v" }, "<leader>fs", snacks.picker.pickers, { desc = "Select finder" })
...
vim.keymap.set("n", "<leader>X", snacks.bufdelete.invisible, { desc = "Close inivisible buffers" })
